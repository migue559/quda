...
conf = pyspark.SparkConf().setAppName("trn_arc_pyspark_bkp_pruebas_tbalteracion").setMaster("local[4]")
...
hdfs.put('tmp'+src+'/'+fileName, '/dev/la/lt_siais/TBALTERACION/'+fileName)
